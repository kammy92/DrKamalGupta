package com.bjp.drkamalgupta.utils;
...
public class AppConfigTags {
    ...
    public static final String EMPLOYEE_WORK_EMAIL = "employee_work_email";
    public static final String EMPLOYEE_IMAGE = "employee_image";
    public static final String EMPLOYEE_LOGIN_ID = "employee_login_id";
    public static final String EMPLOYEE_LOGIN_PASS = "employee_login_pass";
    ...
    public static final String CLIENT_SKYPE = "client_skype";
